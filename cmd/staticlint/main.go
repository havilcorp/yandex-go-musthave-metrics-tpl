// Package main статический анализатор кода
//
// Этот пакет включает в себя:
//   - стандартный статический анализ из пакета golang.org/x/tools/go/analysis/passes;
...
//
// Для запуска анализатора воспользуйтесь коммандой: go run cmd/staticlint/main.go ./...
package main
...
func main() {
	...
	logrus.Infof("Анализаторов %d шт.", len(mychecks))
